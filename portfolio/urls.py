...
urlpatterns = [
    ...
    path('new_pessoa', views.new_pessoa_page_view, name ='new_pessoa'),
    path('edit_pessoa/<int:pessoa_id>', views.edita_pessoa_view ,name = 'edit_pessoa'),
    path('apaga_pessoa/<int:pessoa_id>', views.apaga_pessoa_view, name='apaga_pessoa'),
    path('quizz', views.quizz, name = 'quizz'),
    path('login', views.view_login, name='login'),
    path('logout', views.view_logout, name='logout'),
    path('meteorologia', views.meteorologia_view, name='meteorologia'),
    path('laboratorios', views.labs_page_view, name='laboratorios')
